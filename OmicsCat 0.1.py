...
# Tomics (transciptomics - but can be any generic -omics dataset)
tomics = pd.read_csv("file_path")
...
# Pomics (proteomics - can be any generic -omics dataset)
pomics = pd.read_csv("file_path")
...
# Gomics (glycomics - can be any generic -omics dataset)
gomics = pd.read_csv("file_path")
