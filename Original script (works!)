...
tomics = pd.read_csv(r"file\path.csv")
...
pomics = pd.read_csv(r"file\path.csv")
...
gomics = pd.read_csv(r"file\path.csv")
...
net.show(r"file\path.html")  # Note: a html file will be created which contains the network - open in your web browser
